...
Implement the ThroneInheritance class:
  ...
  3. void death(string name) Indicates the death of name. The death of the person doesn't affect the 4. Successor function nor the current inheritance order. You can treat it as just marking the person as dead.
  5. string[] getInheritanceOrder() Returns a list representing the current order of inheritance excluding dead people.
